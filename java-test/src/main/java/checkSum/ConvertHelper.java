...
public final class ConvertHelper {
     ...
     * 判断两个byte数组是否完全相同
     *
     * @param firstByteArray  数据数值
     * @param secondByteArray 进制
     * @return 字节值
     */
     ...
     *
     * @param value  字符型日期
     * @param format 格式（"yyyy-MM-dd HH:mm:ss.SSS"）
     * @return Date 日期
     */
     ...
     *
     * @param bytes       字节数组
     * @param charsetName 字符编码名称（如：UTF-8）
     * @return 字符串
     */
...
//
     ...
     *
     * @param b1 　原数组
     * @return　格式化后的数组 create Date 2013-07-12 16:42:48
     */
